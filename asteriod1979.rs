...
use crate::asteriod1979_spawn_ast;
use asteriod1979_spawn_ast::Asteroids;
...
pub fn asteriods_game() {
    let mut app = App::new();
        ...
        app.add_systems(Update, (
            asteriod1979_spawn_ast::spawn_asteroids,
            asteriod1979_spawn_ast::move_asteroids,
...
pub fn handle_collision_events(
    ...
    for event in events.read() {
        ...
        match event {
            GameEvents::ShipCollideWithAsteroid(_player) => {
